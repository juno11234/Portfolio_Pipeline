...
> **뱀서라이크는 이미 코드 유래로 넘어갔다**(2026-07-18, 위 "지금 상태"). 이 표의 뱀서 PDF 는 더 이상 출처가 아니다 — Bond·SoulLike 만 아직 PDF 유래.
...
라이브: **https://juno11234.github.io/Portfolio_Pipeline/** (Bond·SoulLike 은 아직 PDF 유래).
